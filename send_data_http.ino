...
void postOnEndpoint(){
  ...
  sendsim808("AT+SAPBR=3,1,\"APN\",\"vodafone\"");  // juste haka bedlo
  sendsim808("AT+SAPBR=1,1",3000);
  sendsim808("AT+HTTPINIT");  
  sendsim808("AT+HTTPPARA=\"CID\",1");
  String url = "AT+HTTPPARA=\"URL\",\"us-central1-fir-android-6c15f.cloudfunctions.net/getGPS?longitude="+longitude+"&latitude="+latitude+"\"";
